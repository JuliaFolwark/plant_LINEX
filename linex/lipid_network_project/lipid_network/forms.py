...
class Version2Specific(forms.Form):
    #https://www.plantcyc.org/about/plantcyc-species
    organism = forms.CharField(
        label="Species from the PMN (full latin name) or leave empty", max_length=50, min_length=0, initial='Plantcyc',
        help_text='See available species <a href="https://www.plantcyc.org/about/plantcyc-species">here</a>'
    )
